...
#define _FS_TIMEOUT		100	/* Timeout period in unit of time tick */
#define	_SYNC_t			RAW_SEMAPHORE * /* O/S dependent sync object type. e.g. HANDLE, OS_EVENT*, ID, SemaphoreHandle_t and etc.. */
