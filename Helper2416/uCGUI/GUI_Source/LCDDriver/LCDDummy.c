...
#include "GUIDebug.h"
#include <raw_api.h>
#include "lcd_driver.h"		//ZhangGQ add 20120404
...
#else
	LCD_SetBitmap( x, y, p, Diff, xsize, pTrans);
#endif
}
...
/* Convert logical into physical coordinates (Dep. on LCDConf.h) */
  ...
  /* Write into hardware ... Adapt to your system */
  {
    /* ... */
	  ...
	  LCD_one_pixel_write(x,y,PixelIndex);  //ZhangGQ add 20130404
  }
...
/* Convert logical into physical coordinates (Dep. on LCDConf.h) */
  ...
  {
   // PixelIndex = 0;/* ... */
	  PixelIndex = (LCD_PIXELINDEX)LCD_one_pixel_read(x,y);	//ZhangGQ add 20130404
  }
...
#endif
#if 1	//ZhangGQ changed 20130409
  if (GUI_Context.DrawMode & LCD_DRAWMODE_XOR)
  {
	 LCD_drawing_Horizon_line( y, x0, x1,LCD_NUM_COLORS - LCD_COLORINDEX - 1);
  }
  else
  {
	  LCD_drawing_Horizon_line( y, x0, x1,LCD_COLORINDEX);
  }
#endif
}
#endif
...
#endif /* (-17LCD_CONTROLLER undefined) */
